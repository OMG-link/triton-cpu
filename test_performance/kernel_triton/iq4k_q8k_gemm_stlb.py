...
def iq4k_q8k_matmul_kernel(
    ...
    value_table = tl.arange(0, NR).cast(tl.int8).reshape(1, NR).broadcast_to((16,NR))
    ...
    for k_block in range(N_block):
        ...
        for sub_block in range(NUM_SUB_BLOCKS):
            ...
            tlb_start_idx_1 = (tlb_start_idx & 0x01).cast(tl.int8)  # [NR] 
            tlb_start_idx_2 = (tlb_start_idx & 0x02).cast(tl.int8)  # [NR] 
